...
if __name__ == '__main__':
    ...
    plt.show()
    # 打印結果
    print(f"The distance between the two audio files is: {distanceAVG}")
    print(f"The DTW path is: {pathAVG}")
    print(f"The distance between the two audio files is: {distancePIT}")
    print(f"The DTW path is: {pathPIT}")
    print(f"The distance between the two audio files is: {distanceMFCC}")
